...
// Copied from Immich, needs to be improved, maybe the iOS back arrow and a Done button?
...
class _SelectionSliverAppBarState extends ConsumerState<SelectionSliverAppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    onDone(Set<BaseAsset> selected) async {
      final result = await ref.read(actionProvider.notifier).upload(ActionSource.timeline);
